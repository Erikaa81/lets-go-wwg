//No nosso conteúdo, temos um exemplo de validação de CPF. Porém, esse se encontra incompleto.
//Complete o exemplo adicionando o algoritimo de verificação dos digitos verificadores, e faça com que o cpf formatado
//(e.g 111.111.110-30) seja aceito também por meio de um construtor.
